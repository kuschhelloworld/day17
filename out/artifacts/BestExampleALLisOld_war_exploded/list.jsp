...
<div class="container">
    ...
    <div style="float: left; margin-bottom: 5px" align="8px">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="${condition.email[0]}" class="form-control"
    ...
    <div style="float: right; margin-bottom: 5px" align="8px">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <span style="font-size: 25px">
                    共${pb.totalCount}页记录，共${pb.totalPage}页
                </span>
            </ul>
        </nav>
    </div>
